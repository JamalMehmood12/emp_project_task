                  ...
                  <table class="content-table">
                      ...
                      <?php while($row=mysqli_fetch_assoc($result)) {?>
                        <tr>
                            ...
                            <td class='edit'><a href='update-emp.php?id=<?php echo $row['EmployeeId']; ?>'><i class='fa fa-edit'></i></a></td>
                            <td class='delete'><a href='deleteemployee.php?id=<?php echo $row['EmployeeId']; ?>'><i class='fa fa-trash-o'></i></a></td>
                        </tr> 
                        <?php  } ?>         
                    </tbody>
                    <?php } ?>
